...
{
    public class AdminMenuItemRepository : BaseRepository<Guid, AdminMenuItem>, IAdminMenuItemRepository
    {
        public AdminMenuItemRepository(ApplicationDBContext context) : base(context)
        {
        }

        public async Task<IEnumerable<AdminMenuItem>> GetActiveMenuItemsWithChildrenAsync()
        {
